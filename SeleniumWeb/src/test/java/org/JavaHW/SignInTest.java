...
public class SignInTest {
    ...
    public void signIn(String email, String password) {
        ...
        wait1.until(ExpectedConditions.elementToBeClickable(signInSubmitButton));
    ...
    public void forgotPassword(String email) {
        ...
        System.out.println("passResetButton.isDisplayed() = " + passResetButton.isDisplayed());
        System.out.println("passResetButton.isEnabled() = " + passResetButton.isEnabled());
    }
    ...
    public void signUpInstead() {
        signInButton.click();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.visibilityOf(signUpNoAccount));
        JavascriptExecutor js = (JavascriptExecutor) driver;
